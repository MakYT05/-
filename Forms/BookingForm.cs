...
namespace InsuranceApp.Forms
{
    public class BookingForm : Form
    {
        ...
        private void InitializeControls()
        {
            ...
            tbFio.Location = new Point(120, y); tbFio.Width = 240;
            Controls.Add(tbFio);

            y += 40;
            Controls.Add(MakeLabel("Телефон:", 20, y));
            tbPhone.Location = new Point(120, y); tbPhone.Width = 240;
            Controls.Add(tbPhone);

            y += 40;
            Controls.Add(MakeLabel("Дата визита:", 20, y));
            datePicker.Location = new Point(120, y); datePicker.Width = 240;
            ...
            cbTime.Location = new Point(120, y); cbTime.Width = 240;
